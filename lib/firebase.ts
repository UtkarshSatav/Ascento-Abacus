...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "ascento-abacus.firebaseapp.com",
  databaseURL: `https://${process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "ascento-abacus"}-default-rtdb.firebaseio.com`,
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "ascento-abacus",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "ascento-abacus.firebasestorage.app",
