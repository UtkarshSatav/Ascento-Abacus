...
const validateFirebaseToken = require('../../middleware/validateFirebaseToken');
const classRoutes = require('../class/class.routes');
const dashboardController = require('../dashboard/dashboard.controller');
const dashboardFirebaseController = require('../dashboard/dashboard.firebase.controller');
const domainRoutes = require('../domain/domain.routes');
const enquiryAdminRoutes = require('../enquiry/enquiry.admin.routes');
const enquiryFirebaseController = require('../enquiry/enquiry.firebase.controller');
...
const feeFirebaseController = require('../fee/fee.firebase.controller');
...
const studentFirebaseController = require('../student/student.firebase.controller');
...
// Firebase Dashboard analytics (New) → GET /api/admin/dashboard-firebase
adminRouter.get('/dashboard-firebase', validateFirebaseToken, dashboardFirebaseController.getDashboardAnalytics);

// Student Firebase Routes
adminRouter.get('/students/firebase', validateFirebaseToken, studentFirebaseController.listStudents);
adminRouter.post('/students/firebase', validateFirebaseToken, studentFirebaseController.createStudent);
adminRouter.get('/students/firebase/:id', validateFirebaseToken, studentFirebaseController.getStudent);
adminRouter.patch('/students/firebase/:id', validateFirebaseToken, studentFirebaseController.updateStudent);
adminRouter.delete('/students/firebase/:id', validateFirebaseToken, studentFirebaseController.deleteStudent);

// Enquiry Firebase Routes
adminRouter.get('/enquiries/firebase', validateFirebaseToken, enquiryFirebaseController.listEnquiries);
adminRouter.get('/enquiries/firebase/:id', validateFirebaseToken, enquiryFirebaseController.getEnquiry);
adminRouter.patch('/enquiries/firebase/:id', validateFirebaseToken, enquiryFirebaseController.updateEnquiry);
adminRouter.delete('/enquiries/firebase/:id', validateFirebaseToken, enquiryFirebaseController.deleteEnquiry);

// Fee Firebase Routes
adminRouter.get('/fees/firebase', validateFirebaseToken, feeFirebaseController.listFees);
adminRouter.post('/fees/firebase', validateFirebaseToken, feeFirebaseController.createFee);
adminRouter.post('/fees/firebase/mark-paid', validateFirebaseToken, feeFirebaseController.markAsPaid);
adminRouter.get('/fees/firebase/student/:studentId', validateFirebaseToken, feeFirebaseController.listForStudent);
